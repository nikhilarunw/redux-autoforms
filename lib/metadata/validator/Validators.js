...
var Validators = function () {
    ...
    _createClass(Validators, null, [{
         ...
         * @returns {*}
         */
        value: function validateArray(propertyMetadata, modelValue, model, validator, globalScope) {
            ...
            return modelValue.map(function (item) {
                return validator.validate(propertyMetadata.fields, item, globalScope);
            });
        }
    }, {
         ...
         * @returns {*}
         */
        value: function validateDateTime(propertyMetadata, modelValue, model, validator, globalScope) {
        ...
        key: 'validateDefault',
        value: function validateDefault(propertyMetadata, modelValue, model, validator, globalScope) {
            if (propertyMetadata.type == 'entity' || propertyMetadata.type == 'array') return undefined;
            if (!propertyMetadata.error) return undefined;

            return _ExpressionEvaluator2.default.evaluate(propertyMetadata.error, model, globalScope);
        }
        ...
        key: 'validateEntity',
        value: function validateEntity(propertyMetadata, modelValue, model, validator, globalScope) {
            if (!modelValue) return undefined;
         ...
         * @returns {*}
         */
        value: function validateFloat(propertyMetadata, modelValue, model, validator, globalScope) {
        ...
        key: 'validateInt',
        value: function validateInt(propertyMetadata, modelValue, model, validator, globalScope) {
            if (modelValue === undefined) return undefined; // null is considered an invalid datetime
        ...
        value: function validateRequired(propertyMetadata, modelValue, model, validator, globalScope) {
            if (!propertyMetadata.required || modelValue !== undefined && modelValue !== null && modelValue !== '') return undefined;

            return _ExpressionEvaluator2.default.evaluate(propertyMetadata.required, model, globalScope) ? 'Required' : undefined;
        }
    }]);
